...
python3 ../kernels_per_batch_size.py 1 2 # Test batch sizes with 2 device and 1 stream
python3 ../kernels_per_batch_size.py 2 2 # Test batch sizes with 2 device and 2 streams
python3 ../kernels_per_batch_size.py 4 2 # Test batch sizes with 2 device and 3 streams
