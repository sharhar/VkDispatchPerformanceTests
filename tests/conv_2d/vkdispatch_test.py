...
if __name__ == "__main__":
    run_test("vkdispatch", io_count, test_function)
    run_test("vkdispatch_transpose", io_count, test_function_transpose)
    run_test("vkdispatch_naive", io_count, test_function_naive)